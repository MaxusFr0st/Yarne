...
import { PRODUCTS, HERO_IMAGES, EDITORIAL_IMG, LOOKBOOK_IMG } from "../data/products";
...
export function Home() {
  ...
  return (
    <main style={{ backgroundColor: "#F5F2ED", fontFamily: "'DM Sans', sans-serif" }}>
      {/* ═══════════════════════════════
          HERO SECTION
      ═══════════════════════════════ */}
      <section
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          {/* Broken Grid – Desktop: 4 products in asymmetric layout */}
          <div className="hidden md:grid grid-cols-12 gap-6 items-start">
            ...
            <div className="col-span-4 flex flex-col gap-6 mt-16">
              <ProductCard product={featured[1]} index={1} size="medium" />
            </div>
            {/* Tall card on right */}
            <div className="col-span-3 mt-8">
              <ProductCard product={featured[2]} index={2} size="medium" />
            </div>
          </div>

          {/* Second row */}
          <div className="hidden md:grid grid-cols-12 gap-6 items-start mt-6">
            <div className="col-span-3">
              <ProductCard product={featured[3]} index={3} size="small" />
            </div>
            {/* Editorial pill CTA */}
      ...
      {/* ═══════════════════════════════
          EDITORIAL SECTION
      ═══════════════════════════════ */}
      <section ref={editorialRef} className="py-20 md:py-28 overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
