...
export function ProductDetail() {
  ...
  if (!loading && !product) {
    return (
      <main
        className="min-h-[var(--app-svh)] flex flex-col items-center justify-center"
  ...
  return (
    ...
    <main className="min-h-[var(--app-svh)]" style={{ backgroundColor: "#F3EFE8" }}>
      ...
      {product === null ? (
        <div className="min-h-[calc(var(--app-svh)*0.5)]" aria-busy="true" />
      ) : (
        <>
      ...
      <div className="hidden md:block max-w-[1360px] mx-auto px-6 md:px-12 pt-[calc(var(--main-header-h)+16px)] pb-[120px]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-[88px_1fr_420px] gap-6 items-stretch mt-0">
          ...
          <div className="w-full flex flex-col self-start">
            <motion.div
              className="relative rounded-[28px] overflow-hidden bg-[#EDE9E2] max-h-[calc(var(--app-svh)-200px)]"
              initial={false}
