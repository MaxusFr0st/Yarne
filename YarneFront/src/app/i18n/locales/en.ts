...
const en = {
  ...
  checkout: {
    ...
    shippingEstimateLabel: "Delivery cost",
    shippingEstimateCalculating: "Calculating…",
    shippingEstimateNote: "paid to Nova Poshta on pickup",
    ...
    errorPhoneTooLong: "Too many digits",
    errorPhoneTooShort: "Number incomplete",
