...
const en = {
  ...
  checkout: {
    ...
    delivery: "Delivery",
    deliverySelectWarehouse: "Choose a branch",
    deliveryChangeWarehouse: "Change branch",
    deliveryPlaceholder: "No branch or postomat selected",
    deliveryRequired: "Choose a Nova Poshta branch or postomat.",
    novaPoshtaModalTitle: "Choose a Nova Poshta branch",
    novaPoshtaClose: "Close",
    errors: {
  ...
  account: {
    ...
    tracking: {
      title: "Track a parcel by tracking number",
