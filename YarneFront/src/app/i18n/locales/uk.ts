...
const uk: Translations = {
  ...
  home: {
    ...
    scrollStory: {
      whyEyebrow: "Чому Yarné",
      whyTitle: "Варто купити. Зроблено, щоб лишатися.",
      whyPoints: ["Натуральні волокна", "Повільне виробництво", "Ремонтоздатні речі", "Передаються далі"],
      side1Eyebrow: "Силует",
      side1Title: "Пропорції для щоденного ритуалу",
      side1Body:
        "Чисті лінії, тихий об’єм і фурнітура, що старіє разом із вами — супутник, а не трендовий flip.",
      side1Cta: "Переглянути колекцію",
      side2Eyebrow: "Матеріал",
      side2Title: "Волокна з походженням",
      side2Body:
        "Від нагірних мануфактур до андських отар — обираємо дотик і довговічність, щоб речі лишалися в оберті.",
      side2Cta: "Нові надходження",
      side3Eyebrow: "Деталь",
      side3Title: "Оздоблення, яке відчувається",
      side3Body:
        "Краї, ремінці й щільність стібка вивірені так, щоб сумка виглядала зібрано зблизька й зі сторони.",
      side3Cta: "Хіти продажів",
