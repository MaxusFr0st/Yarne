...
const uk: Translations = {
  ...
  checkout: {
    ...
    delivery: "Доставка",
    deliverySelectWarehouse: "Обрати відділення",
    deliveryChangeWarehouse: "Змінити відділення",
    deliveryPlaceholder: "Відділення або поштомат не обрано",
    deliveryRequired: "Оберіть відділення або поштомат Нової пошти.",
    novaPoshtaModalTitle: "Вибрати відділення Нової пошти",
    novaPoshtaClose: "Закрити",
    errors: {
