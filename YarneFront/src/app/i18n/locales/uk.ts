...
const uk: Translations = {
  ...
  home: {
    ...
    why: {
      ...
      items: [
        {
          word: "Femmora",
          caption: "Femmora — в'язана сумка на плече",
          title: "В'язано вручну, а не масово",
          body: "Кожну сумку в'яже один майстер — від початку до кінця.",
        },
        {
          word: "Cherie",
          caption: "Cherie — в'язана міні-сумка",
          title: "Натуральні волокна, створені надовго",
          body: "Пряжу обираємо за довговічністю, а не за модними циклами.",
        },
        {
          word: "Dva Shopper",
          caption: "Dva Shopper — в'язаний шопер",
          title: "Виготовлення на замовлення — за дні, не місяці",
          body: "Жодних складських залишків — кожне замовлення в'яжеться заново.",
        },
      ],
      care: {
        word: "Yarné Care",
        title: "Yarné Care — дбаємо про сумку після покупки",
        items: [
          { title: "Перев'яжемо", body: "Пошкодилась — відновимо петля за петлею." },
          { title: "Виперемо", body: "Дбайливе прання вовни у нашій майстерні." },
          { title: "Повернення безкоштовне", body: "Не підійшла — забираємо за наш кошт." },
        ],
        linkLabel: "Умови догляду",
      },
    },
  },
  showcase: {
  ...
  checkout: {
    ...
    shippingEstimateLabel: "Вартість доставки",
    shippingEstimateCalculating: "Розраховуємо…",
    shippingEstimateNote: "оплата Новій пошті при отриманні",
    eurReferenceNote: "Стягується в ₴ — € показано для довідки.",
    errorEmail: "Перевірте пошту",
    errorNameTooLong: "Задовге",
    errorNameCyrillicOnly: "Лише кирилицею",
    errorPhoneLetters: "Лише цифри",
    errorPhoneTooLong: "Забагато цифр",
    errorPhoneTooShort: "Номер неповний",
  ...
  account: {
    ...
    tracking: {
      title: "Відстежити посилку за номером ТТН",
      placeholder: "Номер ТТН",
      button: "Відстежити",
      loading: "Пошук…",
      errors: {
        notFound: "Замовлення з таким номером ТТН не знайдено у вашому акаунті.",
        invalidFormat: "Номер ТТН має містити 11 або 14 цифр, без пробілів і символів.",
      },
    },
    errors: {
